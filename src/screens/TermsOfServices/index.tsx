      ...
      <View style={styles.wrapper}>
        {route.params.type === 'shipping' && (
          <>
            ...
            <Text style={styles.des}>
              {'   '}We ship all order through trusted courier partner Fed-Ex
              and is chargeable depending upon destination country. The same
              shall be added in checkout process in billing and shipping
              information page.
            </Text>
            ...
            <Text style={styles.des}>
              ...
              delivery, Courier Company will try to make 3 attempts to deliver
              the product. In case you are still not reachable / available, the
              same will be returned to our facility in Mumbai.
            </Text>
            <Text style={styles.title}>Delivery Location:</Text>
            <Text style={styles.des}>
